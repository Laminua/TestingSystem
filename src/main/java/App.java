...
public class App {
    public static void main(String[] args) {
        ...
        // лист вопросов всех видов в одном тесте
        List<Question> test4questions = Stream.of(tes1questions, test2questions, test3questions)
        ...
        Test test4 = new Test("4-й тест - все виды вопросов", test4questions);

        // создаём список тестов для показа
        List<Test> testList = Arrays.asList(test1, test2, test3, test4);
